...
const AddShoe = (props) => {
    ...
    return (
        <div>
          ...
          id="add_shoe_accordion"
        >
          <Typography className={classes.heading} color="secondary">ADD SHOE TO CLOSET</Typography>
        </AccordionSummary>
          <AccordionDetails >
          <form className={classes.form} onSubmit={(e) => submitAdd(e)}>
