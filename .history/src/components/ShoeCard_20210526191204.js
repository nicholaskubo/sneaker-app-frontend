  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions>
        ...
        <Button size="small" color="primary"> Like</Button>
        <Link to={`/user_shoe/${props.shoe.shoe.id}`} className={classes.names} style={{ textDecoration: 'none' }}>
          <Button size="small" color="primary">
            More Info
          </Button>
        </Link>
        <Link to={`/user/${props.shoe.id}`} className={classes.names} style={{ textDecoration: 'none' }}>
          <Button size="small" color="primary">
