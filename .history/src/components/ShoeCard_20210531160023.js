 ...
 const submitAddLike = () => {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions>
      {console.console.log(props.shoe.likes.filter(l => l.user_id == localStorage.getItem("user_id")));}

        {props.shoe.likes.filter(l => l.user_id == localStorage.getItem("user_id")) ? <FavoriteIcon/> : <FavoriteBorderIcon/>}
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(ShoeCard));
