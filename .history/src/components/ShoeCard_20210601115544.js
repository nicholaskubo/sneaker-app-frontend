...
const handleClick = () => {
 ...
 const submitAddLike = () => {
    ...
    //  console.log(props.likes.filter(l => l.user_id == localStorage.getItem("user_id")).find(l => l.user_shoe_id == props.shoe.id))
  return (
    <Card className={classes.root}>
      ...
      {props.likes.find(l => l.user_id == localStorage.getItem("user_id")) ? <FavoriteIcon/> : <FavoriteBorderIcon/>}


         <div> {props.likes.filter(l => l.user_shoe_id == props.shoe.id).length} </div>
        { props.likes.filter(l => l.user_id == localStorage.getItem("user_id")).find(l => l.user_shoe_id == props.shoe.id) ?
        <Button size="small" color={flag ? "primary" : "secondary"} onClick={(e) => props.deleteLike(props.likes.filter(l => l.user_id == localStorage.getItem("user_id")).find(l => l.user_shoe_id == props.shoe.id)).then(handleClick())}> Unlike</Button>
        :
        <Button size="small" color={flag ? "primary" : "secondary"} onClick={(e) => submitAddLike()}> Like</Button>
        }
      ...
      <Accordion>
        ...
        <AccordionDetails>
        <CardContent className={classes.moreInfo}>
        {props.comments.filter(l => l.user_shoe_id == props.shoe.id).map(s => s.content)}
