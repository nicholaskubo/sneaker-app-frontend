  ...
  return (
    <Card className={classes.root}>
      ...
      {props.likes.find(l => l.user_id == localStorage.getItem("user_id")) ? <FavoriteIcon/> : <FavoriteBorderIcon/>}
        ...
        <Button size="small" color={flag ? "secondary" : "primary"} onClick={(e) => props.deleteLike(props.likes.filter(l => l.user_id == localStorage.getItem("user_id")).find(l => l.user_shoe_id == props.shoe.id))}> Unlike</Button>
        :
