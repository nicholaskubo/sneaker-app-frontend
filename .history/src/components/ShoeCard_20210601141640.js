  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions >
        ...
        <Button size="small" color={"secondary"} className={classes.buttons} onClick={(e) => props.deleteLike(props.likes.filter(l => l.user_id == localStorage.getItem("user_id")).find(l => l.user_shoe_id == props.shoe.id))}> Unlike</Button>
        :
        <Button size="small" color={"primary"} className={classes.buttons} onClick={(e) => submitAddLike()}> Like</Button>)
        }
        
        <Link to={`/user/${props.shoe.user.id}`} className={classes.closet}>
          <Button size="small" className={classes.buttons} color="primary">
      ...
      <Accordion>
        ...
        <CardContent className={classes.moreInfo}>
          ...
          }
          {
            ...
            props.shoe.shoe.retail_price == "0" || props.shoe.shoe.retail_price == null  ? 
            null :  
            <Typography variant="subtitle2" > Retail Price: ${props.shoe.shoe.retail_price}  </Typography>
