    ...
    <Card className={classes.root}>
      ...
      <CardActions>
        ...
        <Button size="small" color={"primary"} onClick={(e) => submitAddLike()}> Like</Button>)
          ...
          <MeetingRoomIcon className={classes.closetIcon}>s</MeetingRoomIcon>
        
        <Link to={`/user/${props.shoe.user.id}`}  style={{ textDecoration: 'none' }}>
        

          <Button size="small" className={classes.closet} color="primary">
            {props.shoe.user.username}'s Closet
          </Button>
        </Link>
         <MeetingRoomIcon className={classes.closetIcon}/>
      </CardActions>
      <Accordion>
        <AccordionSummary
