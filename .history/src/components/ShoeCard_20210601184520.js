  ...
  return (
    <Card className={classes.root}>
      ...
      <Accordion>
        ...
        <AccordionDetails>
        <CardContent className={classes.moreInfo}>
        {props.comments.filter(l => l.user_shoe_id == props.shoe.id).map(c => <Comment key={c.id} comment={c} comments={comments}/>)}
        <TextField
                  ...
                  style={{ width: "100%" }}
                />
                <Button size="small" color={"primary"} type="submit"  onSubmit={(e) => submitAddComment()}> Add Comment</Button> 
          </CardContent>
        </AccordionDetails>
      </Accordion>
    </Card>
