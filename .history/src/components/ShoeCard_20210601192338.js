  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions className={classes.buttons}>
        {props.likes
          .filter((l) => l.user_id == localStorage.getItem("user_id"))
          .find((l) => l.user_shoe_id == props.shoe.id) ? (
          <FavoriteIcon />
        ) : (
          <FavoriteBorderIcon />
        )}
        ...
        <div>
          {" "}
          {
            props.likes.filter((l) => l.user_shoe_id == props.shoe.id).length
          }{" "}
        </div>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <CardContent className={classes.moreInfo}>
            ...
            {props.shoe.shoe.retail_price == "0" ||
            props.shoe.shoe.retail_price == null ? null : (
              <Typography variant="subtitle2">
                {" "}
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <CardContent className={classes.moreInfo}>
            {props.comments
              .filter((l) => l.user_shoe_id == props.shoe.id)
              .map((c) => (
                <Comment key={c.id} comment={c} comments={comments} />
              ))}
            {localStorage.getItem("user_id") ? (
              <TextField
