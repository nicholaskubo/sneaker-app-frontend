...
const Profile = (props) => {
    ...
    console.log(props.likes.filter(l => l.user_id == user_id).map(t => t.user_shoe_id))
    ...
    return (
        <div>
            ...
            <UserLikesCardContainer user_shoes={props.user_shoes} likes={props.likes} comments={props.comments} ></UserLikesCardContainer>
        </div>
    )
}
